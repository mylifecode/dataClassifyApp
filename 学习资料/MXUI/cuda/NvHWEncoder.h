 ...
 *
 */
#ifndef NVHWENCODER_HWHEAD_H
#define NVHWENCODER_HWHEAD_H
...
public:
	...
	void SetOutputFileName(const std::string& fileName) { m_fileName = fileName; }
	std::string m_fileName;

	NV_ENC_SEQUENCE_PARAM_PAYLOAD m_sequenceParam;
#define SPS_PPS_BUFFER_SIZE 512
	unsigned char m_spsppsInfo[SPS_PPS_BUFFER_SIZE];
	uint32_t m_spsppsLength;

	MxVideoWriter* m_videoWriter;
};
