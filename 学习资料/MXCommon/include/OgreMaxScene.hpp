...
//             OgreMaxSceneCallback* callback = 0,
        ...
        /** Same as GetEntity(), but for lights. */
		Ogre::Light* GetLight(const Ogre::String& name, bool nameIncludesPrefix);
		...
		typedef std::map<const Ogre::String, Ogre::Real> AnimationStatesSpeed;

        /** Gets all the animation states created by the scene */
        AnimationStates& GetAnimationStates();
		void SetAnimationState(const Ogre::String& animationName,Ogre::AnimationState* animateState);
		...
		void SetAnimationStateSpeed(const Ogre::String& animationName,Ogre::Real animateStateSpeed);
		Ogre::Real GetAnimationStateSpeed(const Ogre::String& animationName);
...
//         OgreMaxSceneCallback* callback;
		...
		AnimationStatesSpeed animationStatesSpeed;
