...
{
public:
	Ogre::MaterialPtr GetFinalToneMatPtr();
	Ogre::MaterialPtr GetBrightpassPtr();
	//for ssss
	Ogre::MaterialPtr GetSSSSBlurXMatPtr();
	Ogre::MaterialPtr GetSSSSBlurYMatPtr();
