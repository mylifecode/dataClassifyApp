...
class CDissectingForcepsSize10 : public CElectricTool
{
public:
	CDissectingForcepsSize10();
	CDissectingForcepsSize10(CXMLWrapperTool * pToolConfig);
	virtual ~CDissectingForcepsSize10(void);
	...
	virtual int  TryBurnConnectStrips(VeinConnectObject * stripObj, float BurnRate, std::vector<Ogre::Vector3> & burnpos, std::vector<VeinConnectPair*> & burnPairs);
