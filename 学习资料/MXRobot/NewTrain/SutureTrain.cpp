...
//=============================================================================================
CSutureTrain::CSutureTrain(void)
{
	m_Needle = 0;
...
//======================================================================================================================
bool CSutureTrain::Initialize(CXMLWrapperTraining * pTrainingConfig, CXMLWrapperToolConfig * pToolConfig)
{
    ...
    m_Needle = CreateNeedle(MXOgre_SCENEMANAGER, m_SutureNodeNum, m_SutureRsLength,m_NeedleSkeletonFile);
...
//==========================================================================================================
void CSutureTrain::SetCustomParamBeforeCreatePhysicsPart(MisMedicOrgan_Ordinary * organ)
{
...
//======================================================================================================================
bool CSutureTrain::Update(float dt)
{
	if (m_Needle)
	{
		GFPhysVectorObj<FaceAnchorInfo>& faceanchors = m_Needle->getFaceNeedleAnchors();

		for (GFPhysVectorObj<FaceAnchorInfo>::iterator it = faceanchors.begin();
			it != faceanchors.end();
			it++)
		{
			FaceAnchorInfo anchorinfo = *it;
...
void CSutureTrain::InternalSimulateStart(int currStep, int TotalStep, Real dt)
{
...
void CSutureTrain::InternalSimulateEnd(int currStep, int TotalStep, Real dt)
{
...
//======================================================================================================================
void CSutureTrain::UpdateInOutBallPos()
{	
...
//======================================================================================================================
void CSutureTrain::CalcHolderAngle(MisCTool_PluginRigidHold * rigidholdPlugin)
{
...
MisCTool_PluginRigidHold* CSutureTrain::GrabNeedleStateInternal(CTool* tool)
{
...
void CSutureTrain::GrabNeedleState()
{
...
//======================================================================================================================
bool CSutureTrain::GetBaseBallPos(const int i, GFPhysVector3& pos)
{
	if (i > 3 || i < 0)
	{
		return false;
...
//======================================================================================================================
void CSutureTrain::OnCreateInAnchor(const GFPhysSoftBodyFace* face, const Real weights[])
{
...
//======================================================================================================================
void CSutureTrain::OnCreateOutAnchor(const GFPhysSoftBodyFace* face, const Real weights[])
{
	GFPhysVector3 anchorpos = face->m_Nodes[0]->m_CurrPosition * weights[0]
		+ face->m_Nodes[1]->m_CurrPosition * weights[1]
		+ face->m_Nodes[2]->m_CurrPosition * weights[2];
...
//======================================================================================================================
void CSutureTrain::OnRemoveInAnchor(const GFPhysSoftBodyFace* face, const Real weights[])
{
...
//======================================================================================================================
void CSutureTrain::OnRemoveOutAnchor(const GFPhysSoftBodyFace* face, const Real weights[])
{
	GFPhysVector3 pos = face->m_Nodes[0]->m_CurrPosition * weights[0]
		+ face->m_Nodes[1]->m_CurrPosition * weights[1]
		+ face->m_Nodes[2]->m_CurrPosition * weights[2];
...
//======================================================================================================================
void CSutureTrain::OnSwitchAnchor(const GFPhysSoftBodyFace* face, const Real weights[])
{
...
//======================================================================================================================
void CSutureTrain::OnMovingRopeAnchor(const SutureThread * thread,const int index, const Real weights[])
{
}
//======================================================================================================================
void CSutureTrain::OnRemoveRopeAnchor(const GFPhysSoftBodyFace* face, const Real weights[])
{
	GFPhysVector3 anchorpos = face->m_Nodes[0]->m_CurrPosition * weights[0]
		+ face->m_Nodes[1]->m_CurrPosition * weights[1]
		+ face->m_Nodes[2]->m_CurrPosition * weights[2];
...
//======================================================================================================================
void CSutureTrain::OnSaveTrainingReport()
{
	float scaleParam = 0;
...
void CSutureTrain::OnCollisionKeep(GFPhysCollideObject * objA, GFPhysCollideObject * objB, const GFPhysManifoldPoint * contactPoints, int NumContactPoints)
{
...
//======================================================================================================================
void CSutureTrain::DetectNeedleLost()
{
...
//======================================================================================================================
void CSutureTrain::DetectNeedleLostCreate()
{
...
//======================================================================================================================
void CSutureTrain::DrawMarkRenderTarget()
{
	if (m_bMarkState)
	{
...
//======================================================================================================================
void CSutureTrain::KeyPress(QKeyEvent * event)
{
	MisNewTraining::KeyPress(event);
}
//======================================================================================================================
void CSutureTrain::OnSimpleUIEvent(const SimpleUIEvent & event)
{
