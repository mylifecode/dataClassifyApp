#ifndef _SUTURETRAIN_
#define _SUTURETRAIN_
...
//=============================================================================================
class CSutureTrain : public MisNewTraining, public NeedleActionListener
{

public:
	CSutureTrain(void);

	virtual ~CSutureTrain(void);
